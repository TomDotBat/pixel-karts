...
if CLIENT then
    hook.Add("InitPostEntity", "PIXEL.Karts.AlertNoPIXELUI", function()
        timer.Create("PIXEL.Karts.AlertNoPIXELUI", 15, 0, function()
            chat.AddText(Color(164, 50, 50), "WARNING ", color_white, " - ", Color(47, 128, 200), "PIXEL Karts ", color_white, "is missing the dependency PIXEL UI. Please install it from here: https://github.com/TomDotBat/pixel-ui/releases.")
